...
public class dangnhapdialog extends javax.swing.JDialog {
    ...
    void login() {
        ...
        if (nhanVien == null) {
            MsgBox.alert(this, "Tài khoản hoặc mật khẩu không trùng khớp với hệ thống!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        dangnhapdialog.this.dispose();
        quenmatkhaudialog.main(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dangnhapdialog.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
