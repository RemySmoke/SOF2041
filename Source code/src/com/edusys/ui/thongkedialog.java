...
public class thongkedialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblScoreBoard.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Người Học", "Tên", "Điểm", "Phân Loại"
            }
        ) {
        ...
        tblLearners.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Năm", "Số Người Học", "Ngày Đăng Ký", "Ngày Ra Trường"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false
        ...
        tblSubjectScore.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Chuyên Đề", "Số Học Viên", "Thấp Nhất", "Cao Nhất", "Điểm TB"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        tblRevenue.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Chuyên Đề", "Số Điểm", "Số Học Viên", "Doanh Thu", "Thấp Nhất", "Cao Nhất", "Điểm TB"
            }
        ) {
            boolean[] canEdit = new boolean [] {
