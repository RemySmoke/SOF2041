...
public class khoahocdialog extends javax.swing.JDialog {
    ...
    void alo() {
        String name = Auth.user.getHoTen();
        ...
        try {
            ...
            for (KhoaHoc kh : list) {
                Object[] row = { kh.getMaKH(), kh.getThoiLuong(), kh.getHocPhi(),
                        XDate.toString(kh.getNgayKG(), "dd-MM-yyyy"), kh.getMaNV(),
    ...
    void insert() {
        ...
        try {
            ...
            MailService.MailService("Thông Báo Từ Hệ Thống",
                    "Nhân Viên:" + Auth.user.getHoTen() + " Đã Tạo Khóa Học Mới");
        } catch (Exception e) {
    ...
    void update() {
        ...
        try {
            ...
            MailService.MailService("Thông Báo Từ Hệ Thống",
                    "Nhân Viên:" + Auth.user.getHoTen() + " Đã Cập Nhật Khóa Học");
        } catch (Exception e) {
    ...
    void delete() {
        if (!Auth.isManager()) {
            MsgBox.alert(this, "Bạn không có quyền hạn để xóa nhân viên!");
        } else {
            ...
            if (MsgBox.confirm(this, "Bạn có muốn xóa chuyên đề này?")) {
                try {
                    ...
                    MailService.MailService("Thông Báo Từ Hệ Thống",
                            "Nhân Viên:" + Auth.user.getHoTen() + " Đã Xóa 1 Khóa Học ");
                } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CHUYÊN ĐỀ", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(khoahocdialog.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
