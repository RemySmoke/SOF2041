...
public class doimatkhaudialog extends javax.swing.JDialog {
    ...
    private void changePassword() {
        ...
        if (!manv.equalsIgnoreCase(Auth.user.getMaNV())) {
            ...
            MailService.MailService("Thông Báo Đổi Mật Khẩu", Auth.user.getHoTen() + " đã đổi mật khẩu");
        }
    }
    ...
    private void initComponents() {
        ...
        lblCurrentPass.setText("Mật khẩu cũ");

        lblNewPass.setText("Mật khẩu mõi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doimatkhaudialog.class.getName())
