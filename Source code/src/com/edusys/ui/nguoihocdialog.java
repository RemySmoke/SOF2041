...
public class nguoihocdialog extends javax.swing.JDialog {
    ...
    void insert() {
        ...
        try {
            ...
            MailService.MailService("Thông Báo Từ Hệ Thống",
                    "Nhân Viên:" + Auth.user.getHoTen() + " Đã Thêm 1 Học Viên Mới");
        } catch (Exception e) {
    ...
    void update() {
        ...
        try {
            ...
            MailService.MailService("Thông Báo Từ Hệ Thống",
                    "Nhân Viên:" + Auth.user.getHoTen() + " Đã Cập Nhật 1 Học Viên");
        } catch (Exception e) {
        ...
        if (!Auth.isManager()) {
            ...
            if (MsgBox.confirm(this, "Do you want to delete this employee?")) {
                try {
                    ...
                    MailService.MailService("Thông Báo Từ Hệ Thống",
                            "Nhân Viên:" + Auth.user.getHoTen() + " Đã Xóa 1 Học Viên");
                } catch (Exception e) {
    ...
    void fillTable() {
        ...
        try {
            ...
            for (NguoiHoc nh : list) {
                Object[] rows = { nh.getMaNH(), nh.getHoTen(), nh.isGioiTinh() ? "Male" : "Female",
    ...
    private void initComponents() {
        ...
        tblLearner.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã", "Tên", "Giới Tính", "Ngày Sinh", "SDT", "Email", "Mã NV", "Ngày Nhập"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nguoihocdialog.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
