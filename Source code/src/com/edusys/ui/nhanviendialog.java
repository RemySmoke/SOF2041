...
public class nhanviendialog extends javax.swing.JDialog {
            ...
            if (!Auth.isManager() && rdoManager.isSelected()) {
                ...
                try {
                    ...
                    MailService.MailService("Thông Báo Từ Hệ Thống",
                            "Nhân Viên:" + Auth.user.getHoTen() + " Đã Thêm 1 Nhân Viên Mới");
                } catch (Exception e) {
    ...
    void update() {
        ...
        if (!mk2.equals(nv.getMatKhau())) {
            ...
            try {
                ...
                MailService.MailService("Thông Báo Từ Hệ Thống",
                        "Nhân Viên:" + Auth.user.getHoTen() + " Đã Cập Nhật Một Nhân Viên Thành Công");
            } catch (Exception e) {
        ...
        if (!Auth.isManager()) {
            ...
            if (manv.equals(Auth.user.getMaNV())) {
                ...
                try {
                    ...
                    MailService.MailService("Thông Báo Từ Hệ Thống",
                            "Nhân Viên:" + Auth.user.getHoTen() + " Đã Xóa Một Nhân Viên Thành Công");
                } catch (Exception e) {
    ...
    void fillTable() {
        ...
        try {
            ...
            for (NhanVien nv : list) {
                Object[] rows = { nv.getMaNV(), nv.getMatKhau().replaceAll(".", "*"), nv.getHoTen(),
                ...
                .addGroup(pnlEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlEditLayout.createSequentialGroup()
                        .addGroup(pnlEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 67, Short.MAX_VALUE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nhanviendialog.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
