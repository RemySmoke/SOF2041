...
public class chuyendedialog extends javax.swing.JDialog {
    ...
    void update() {
        ...
        try {
            ...
            MsgBox.alert(this, "Cập nhập không thành công!");
        }
    }
    
    void delete() {
        if (!Auth.isManager()) {
            MsgBox.alert(this, "Bạn không đủ quyền hạn để xóa nhân viên");
        } else {
    ...
    private void initComponents() {
        ...
        lblName.setText("Khóa Học");

        lblDuration.setText("Thời Lượng Học");
        ...
        tblSubject.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Chuyên Đề", "Khóa Học", "Học Phí", "Thời Lượng Học", "Hình Ảnh"
            }
        ) {
