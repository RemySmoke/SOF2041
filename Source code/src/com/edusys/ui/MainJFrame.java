...
public class MainJFrame extends javax.swing.JFrame {
    ...
    void displayUserInfo() {
        ...
        lblUserInfo.setText("Tài Khoản : " + userID + " |  Chức Vụ: " + role);
    }

    void openChangePassword() {
        if (Auth.isLogin()) {
            new doimatkhaudialog(this, rootPaneCheckingEnabled).setVisible(true);
        } else {
    ...
    void LogOut() {
        Auth.clear();
        this.dispose();
        new dangnhapdialog(this, rootPaneCheckingEnabled).setVisible(true);
    }
    ...
    void openSubjects() {
        new chuyendedialog(this, rootPaneCheckingEnabled).setVisible(true);
    }

    void openCourses() {
        new khoahocdialog(this, rootPaneCheckingEnabled).setVisible(true);
    }

    void openLearners() {
        new nguoihocdialog(this, rootPaneCheckingEnabled).setVisible(true);
    }

    void openStudents() {
        new hocviendialog(this, rootPaneCheckingEnabled).setVisible(true);
    }

    void openEmployees() {
        new nhanviendialog(this, rootPaneCheckingEnabled).setVisible(true);
    }

    void openGuide() {
        try {Desktop.getDesktop().browse(new URI("https://github.com/RemySmoke"));
} catch (Exception e) 
{JOptionPane.showMessageDialog(null,e);}
    ...
    void openResetPass() {
        new quenmatkhaudialog(this, rootPaneCheckingEnabled). setVisible(true);
    }
    ...
    void openStatistics(int index) {
        if (Auth.isLogin()) {
            if (index == 3 && !Auth.isManager()) {
                ...
                thongkedialog statisticJDialog = new thongkedialog(this, true);
    ...
    private void initComponents() {
        ...
        mnuStatistics.setText("Thống Kê");
        ...
        mniSubjectScore.setText("Điểm Chuyên Đề");
